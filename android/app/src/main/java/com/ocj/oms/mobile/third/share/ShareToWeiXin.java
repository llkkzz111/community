...
import com.ocj.oms.mobile.bean.ShareWechatInfo;
...
public class ShareToWeiXin {
    ...
    public void RegisterApp() {
        // 注册微信
        iWXapi = WXAPIFactory.createWXAPI(UIManager.getInstance().getBaseContext(), Constants.WEIXIN_APP_ID, false);
        ...
        if (iWXapi.isWXAppInstalled()) {
            try {
                ...
                if (WXScene == SendMessageToWX.Req.WXSceneSession) {
                    ...
                    //朋友圈
                    msg.title = wechatInfo.getTitle() + "  " + wechatInfo.getDesc();
                    msg.description = wechatInfo.getDesc();
                }
...
//
                    ...
                    Bitmap rawBitmap = BitmapFactory.decodeResource(UIManager.getInstance().getBaseContext().getResources(), R.mipmap.ic_launcher);
