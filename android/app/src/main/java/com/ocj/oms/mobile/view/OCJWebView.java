 ...
 */
public class OCJWebView extends WebView {
    ...
    public OCJWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        _context = context;
        initSettings();
    }

    public OCJWebView(Context context, AttributeSet attrs, int defStyle) {
