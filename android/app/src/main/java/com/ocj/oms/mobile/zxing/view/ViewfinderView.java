...
package com.ocj.oms.mobile.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    private static final int SCANNER_LINE_MOVE_DISTANCE = 10;  //扫描线移动距离
...
//    canvas.drawRect(frame.left + 2, middle - 1, frame.right - 1, middle + 2, paint);
        ...
        if (scannerStart <= scannerEnd - SCANNER_LINE_HEIGHT) {
//            RectF rectF = new RectF(frame.left, scannerStart, frame.right, scannerStart + SCANNER_LINE_HEIGHT);
//
//            Bitmap scanLine = BitmapFactory.decodeResource(getResources(), R.drawable.scan_line);
//            canvas.drawBitmap(scanLine, null, rectF, paint);
            //矩形
