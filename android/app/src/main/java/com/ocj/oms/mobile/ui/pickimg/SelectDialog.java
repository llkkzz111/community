...
public class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    private boolean isRemoveCancel = false;//是否不要取消
    ...
    public void setRemoveCancel(boolean isRemove) {
        isRemoveCancel = isRemove;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        if (isRemoveCancel) {
            view.findViewById(R.id.mBtn_Cancel).setVisibility(View.GONE);
        }
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.text_blue);
                mOtherItemColor = mActivity.getResources().getColor(R.color.text_blue);
            }
            if (1 == mStrings.size()) {
