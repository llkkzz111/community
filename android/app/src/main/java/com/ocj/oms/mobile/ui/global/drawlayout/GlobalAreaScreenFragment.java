...
public class GlobalAreaScreenFragment extends BaseFragment {
    ...
    protected int getlayoutId() {
        return R.layout.global_screen_layout1;
    }
    ...
    protected void initEventAndData() {
        list.add("推荐地区");
        list.add("字母排序");
//        mAdapter = new GlobalFragmentAdapter(getChildFragmentManager(), list,f);
