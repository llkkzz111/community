...
public class PhotoItem extends LinearLayout
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            ...
            //ivCover.setColorFilter(Color.GRAY, PorterDuff.Mode.MULTIPLY);
    ...
    public void setImageDrawable(final PhotoModel photo) {
        this.photo = photo;
        Glide.with(getContext()).load("file://" + photo.getOriginalPath()).asBitmap().error(R.drawable.ic_picture_loadfailed).placeholder(R.drawable.ic_picture_loading).diskCacheStrategy(DiskCacheStrategy.NONE).into(ivPhoto);
