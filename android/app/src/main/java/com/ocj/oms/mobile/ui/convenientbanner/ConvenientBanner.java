...
import com.ocj.oms.mobile.ui.convenientbanner.adapter.CBPageAdapter;
import com.ocj.oms.mobile.ui.convenientbanner.holder.CBViewHolderCreator;
import com.ocj.oms.mobile.ui.convenientbanner.listener.CBPageChangeListener;
import com.ocj.oms.mobile.ui.convenientbanner.listener.OnItemClickListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(DensityUtil.dip2px(App.getInstance(), 5), 0, DensityUtil.dip2px(App.getInstance(), 5), 0);
