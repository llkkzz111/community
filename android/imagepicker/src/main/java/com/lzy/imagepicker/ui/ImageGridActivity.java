...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
        ...
        if (getIntent().hasExtra("profile_setting")) {
            mRecyclerAdapter.SetSingleSelect(true);
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if (getIntent().hasExtra("profile_setting")) {
                intent.putExtra("select_img", imagePicker.getSelectedImages().get(0).path);
