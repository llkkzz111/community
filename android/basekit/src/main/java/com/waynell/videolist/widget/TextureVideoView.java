...
import com.ocj.oms.basekit.BuildConfig;
...
public class TextureVideoView extends TextureView
        ...
        MediaPlayer.OnBufferingUpdateListener , ControllerTextureVideoView.MediaPlayerControl {
    ...
    private static final int STATE_READY_FOR_NEXT = 6;
    ...
    private ControllerTextureVideoView mMediaController;
...
//            attachMediaController();
    ...
    //为了支持分段视频连续播放
    public void stop(String nextUrl){
        if(URLUtil.isNetworkUrl(nextUrl)){
            mTargetState=STATE_READY_FOR_NEXT;
            if(isInPlaybackState()) {
                mVideoHandler.obtainMessage(MSG_STOP,nextUrl).sendToTarget();
            }
        }else{
            stop();
        }
...
//        }
    ...
    public void setMediaController(ControllerTextureVideoView controller) {
        if (mMediaController != null) {
            mMediaController.hide();
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                Log.i("TEXTUREVIDEOVIEW","action down");
                break;

            case MotionEvent.ACTION_UP:
                Log.i("TEXTUREVIDEOVIEW","action up");
                if (isInPlaybackState() && mMediaController != null) {
                    toggleMediaControlsVisiblity();
                }
                break;
            case MotionEvent.ACTION_MOVE:
                Log.i("TEXTUREVIDEOVIEW","action move");
                break;
