...
export default class GetOrderInfoRequest extends BaseRequest {
    requestUrl() {
        return '/api/orders/orders/toSettlement';
    }
        ...
        super.handleResponse(responseJson, (responseJson)=> {
            let response = {
                ...
                baseInfo: {
                    ...
                    invoiceEmail: '',//收票人邮箱
                    totalCount: 0,//商品总件数
                    onlinePayCutDown: false, //在线立减五元标示
                }
            };
            if (responseJson && responseJson.data) {
                ...
                //在线支付立减标示
                response.baseInfo.onlinePayCutDown = data.online_redu_5;
                //获取isInvoice(是否可以开发票)
                if (data.isInvoice) {
