...
export default class GoodsClassifyItem extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            ...
            <View style={this.state.displayDirection == 'row' ? styles.rowContainers : styles.columnContainers}>
                    ...
                    <View>
                        <Image style={this.state.displayDirection == 'row' ? styles.rowImg : styles.columnImg} source={{uri: 'http://cdnimg.ocj.com.cn/item_images/item/15/17/1967/15171967L.jpg'}} />
                    </View>
                ...
                {this.state.displayDirection == 'row' ?
                    <View>
                        <View style={{flexDirection: 'row', marginTop: 10, alignItems: 'flex-start',}}>
                            <View style={{flex:1}}>
                                <Text style={styles.groupProductStyle} allowFontScaling={false}><Text style={styles.groupTitle} allowFontScaling={false}>全球购</Text><Text allowFontScaling={false}> 马克库班 2017 夏季新款 劲爆来袭</Text></Text>
                            </View>
                        </View>
