/**
 * @author YASIN
 * @version [React-Native PABank V01, 17/2/23]
 * @date 17/2/23
 * @description PASwitch.js
 */
            ...
            >
                <View  // the circle
                    style={[
                        ...
                        {backgroundColor: this._getBgColor(), borderColor: "#cccccc", borderWidth: 1,},
                    ]}
                />
...
export default class CCMSSwitch extends Component {
    constructor(props) {
        super(props);
        this.theme = {};
        this.switchStyle = {
    ...
    render() {
        ...
        const mergedStyle = Object.assign({}, this.switchStyle, {
