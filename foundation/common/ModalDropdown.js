/**
 * Created by dongfanggouwu-xiong on 2017/7/11.
 */
'use strict';
...
import {getStatusHeight}from './NavigationBar';
...
export default class ModalDropdown extends Component {
                              ...
                              onPress={this._onButtonPress.bind(this)}>
                {
                    ...
                    (
                        <View style={styles.button}>
                            ...
                            <Image style={{width:12,height:8,marginRight:10,marginTop:15}} source={this.state.showDropdown===false?require('../../foundation/Img/order/Icon_down_gray_@2x.png'):require('../../foundation/Img/order/Icon_up_@2x.png')}/>
                        </View>
                    )
                }
            </TouchableOpacity>
    ...
    _calcPosition() {
        ...
        var style = {
            ...
            top: showInBottom ? this._buttonFrame.y + this._buttonFrame.h - (Platform.OS === 'android'? getStatusHeight() - 10 : 0 ) : Math.max(0, this._buttonFrame.y - dropdownHeight),
        };
