package com.community.imsdk.db;
...
import com.community.imsdk.db.dao.DaoMaster;
import com.community.imsdk.db.dao.DaoSession;
...
//    private JsonEntityDao getJsonEntityDao();
    ...
    public void init(long userId) {
        if (loginUserId != userId) {
            ...
            loginUserId = userId;
            //初始化daoMaster
            String DB_NAME = "communityim_" + userId + ".db";
