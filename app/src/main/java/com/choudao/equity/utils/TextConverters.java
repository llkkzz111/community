        ...
        for (int i = 0; i < systemMsg.list.size(); i++) {
            ...
            spannableString.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    Intent intent = new Intent("com.choudao.equity.action");
...
//        String str = "sds<shikinami|choudao://user_show?id=999999&name=1123 />回答了问题<www.chouwww.choudao.com这个网站里有很多好玩的wwwww.choudao.com这个网站里有很多好玩的w.choudao.com这个网站里有很多好玩的dao.com这个网站里有很多好玩的|question://id:5 />lalallal";
//        String str = "l<我也不知道谁是谁|choudao://user/profile?id=586309 />回答了问题<啦啦啦啦啦啦啦，测试|choudao://question/show?id=512 />";
//        String str = "<qinju_1442307146170|choudao://user/profile?id=571553 />回答了问题<好1 去2 3。 4。 5 8\\n1\\n 7x|choudao://question/show?id=458 />";
        String str = "很抱歉，你们还不是好友关系，请先发送好友验证请求，对方验证通过后，才能聊天。<发送好友验证|choudao://friend/verification?id=586309 />";
