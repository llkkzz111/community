...
import com.choudao.equity.CommunityActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_trading_center:
                ...
                intent.putExtra(IntentKeys.KEY_URL, ConstantUtils.HTTPS_CHOUDAO_TRADING_CENTER);
                startActivity(intent);
                break;
            case R.id.ll_vc_information:
                intent.setClass(getActivity(), WebViewActivity.class);
                intent.putExtra(IntentKeys.KEY_URL, ConstantUtils.HTTPS_CHOUDAO_VC_INFORMATIONS);
                startActivity(intent);
                break;
        }
    }
