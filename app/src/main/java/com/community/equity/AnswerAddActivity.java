...
public class AnswerAddActivity extends BaseActivity {
    ...
    private String JSSetPlaceholder = "javascript:communityJSBridge.setPlaceholder('填写答案内容')";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (!isFinish)
                    Utils.showInput(webView);
                if (type == 1) {
                    webView.loadUrl("javascript:communityJSBridge.setContent('" + answer.getContent() + "')");
                } else if (type == 0) {
