...
import com.community.equity.fragment.ContactsFragment;
import com.community.equity.fragment.ErrorFragment;
import com.community.equity.fragment.FoundFragment;
...
import com.community.equity.utils.VersionUpdate;
...
import com.community.imsdk.dto.action.MsgAction;
import com.community.imsdk.dto.constants.ActionType;
...
//                show(getSupportFragmentManager(), "logout");
    ...
    public void receiverMessageSuccess(MessageType messageType, BaseRequest request, Object response) {
        ...
        switch (messageType) {
            case PUSH_MESSAGE:
                com.community.imsdk.db.bean.Message message = (com.community.imsdk.db.bean.Message) response;
