...
//		return dpValue * (metrics.densityDpi / 160f);
     ...
     * 设置轮播页的图片列表集
     *
     * @param ibAddPageView 通过实现{@link IBViewSetPageView}接口来完成设置
     */
     ...
     *
     * @param ibDotView 通过实现{@link IBViewSetDotView}接口来完成设置
     */
     ...
     * 设置滑动到当前轮播页所需要执行的事件
     *
     * @param ibCurrentPageListener 通过实现{@link IBViewCurrentPageListener}接口来完成设置
     */
    ...
    public interface IBViewSetDotView {
         ...
         */
        void setDotView(ImageView imageView, int positon, int selected);
    }
    ...
    public interface IBViewCurrentPageListener {
         ...
         */
        void setCurrentPageEvent(Object obj, int positioncur);
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = (View) mPageViews.get(position % mPageViews.size());
            try {
