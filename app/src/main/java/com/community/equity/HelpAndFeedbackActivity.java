    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_shengfu_pay_help:
                startNewActivity(ConstantUtils.HTTPS_community_HELP_SHENGFU_PAY);
                break;
            case R.id.ll_term_help:
                startNewActivity(ConstantUtils.HTTPS_community_HELP_TERM);
                break;
            case R.id.ll_qa_help:
                startNewActivity(ConstantUtils.HTTPS_community_HELP_QA);
                break;
            case R.id.ll_bank_help:
                startNewActivity(ConstantUtils.HTTPS_community_HELP_BANK);
                break;
            case R.id.iv_left:
                finish();
                break;
