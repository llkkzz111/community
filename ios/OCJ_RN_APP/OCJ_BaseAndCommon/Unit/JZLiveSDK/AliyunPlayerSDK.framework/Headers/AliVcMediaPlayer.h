 ...
 */
- (AliVcMovieErrorCode) prepareToPlayWithVid: (NSString*)vid acId:(NSString*)acId acKey:(NSString*)acKey stsToken:(NSString*)stsToken domainRegion:(NSString*)domainRegion authInfo:(NSString*)authInfo;
