...
@interface NSArray (SWIFT_EXTENSION(JZMSGCore))
@end


@interface NSData (SWIFT_EXTENSION(JZMSGCore))
@end


@interface NSDictionary (SWIFT_EXTENSION(JZMSGCore))
@end
...
@interface NSNull (SWIFT_EXTENSION(JZMSGCore))
@end


@interface NSString (SWIFT_EXTENSION(JZMSGCore))
@end


SWIFT_CLASS("_TtC9JZMSGCore7SSLCert")
...
SWIFT_CLASS("_TtC9JZMSGCore11SSLSecurity")
...
SWIFT_CLASS("_TtC9JZMSGCore16SocketAckEmitter")
...
SWIFT_CLASS("_TtC9JZMSGCore14SocketAnyEvent")
...
///
/// \endcode
SWIFT_CLASS("_TtC9JZMSGCore19SocketClientManager")
...
SWIFT_CLASS("_TtC9JZMSGCore12SocketEngine")
...
SWIFT_PROTOCOL("_TtP9JZMSGCore16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC9JZMSGCore14SocketIOClient")
...
SWIFT_CLASS("_TtC9JZMSGCore9WebSocket")
