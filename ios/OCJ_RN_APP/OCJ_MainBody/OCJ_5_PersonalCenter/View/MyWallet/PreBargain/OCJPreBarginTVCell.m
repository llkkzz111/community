...
@implementation OCJPreBarginTVCell
...
- (void)setOcjModel_score:(OCJPreBarginModel *)ocjModel_score{
    self.ocjLab_score.text = ocjModel_score.ocjStr_depositamt;
    self.ocjLab_tip.text = ocjModel_score.ocjStr_deposit_note;
