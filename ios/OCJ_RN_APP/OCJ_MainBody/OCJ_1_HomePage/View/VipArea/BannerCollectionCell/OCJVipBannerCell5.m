...
@implementation OCJVipBannerCell5
...
- (void)ocj_setupViews{
    ...
    [titleImg setImage:[UIImage imageNamed:@"icon_service_"] forState:UIControlStateNormal];
    ...
    [lab mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(titleBtn.mas_bottom).offset(30);
    }];
